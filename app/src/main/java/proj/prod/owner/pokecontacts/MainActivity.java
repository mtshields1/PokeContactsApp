package proj.prod.owner.pokecontacts;
...
public class MainActivity extends Activity
{
    ...
    private int high = 152;   //maximum pokedex number (exclusive) for random seed. This should be 1 higher than maximum seed number
